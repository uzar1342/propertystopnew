                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Column(
                                                      ...
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        Text(room[index].bhk.toString(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                                                          SizedBox(height: 2,),
                                                        Text("Carpet Area :"+room[index].propCarpetArea.toString()+"sq.ft",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                                                      ],
                                                    ),
                                                  ),
